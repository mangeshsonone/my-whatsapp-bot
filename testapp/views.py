...
def addin_database(all_data):
    try:
        ...
        try:
            ...
            logger.error(f"Error while getting/creating Samaj with name '{s_name}': {str(e)}")
            return f"Error while getting/creating Samaj: {str(e)}"
        
        # Get or create Family object
        ...
        try:
            ...
            logger.error(f"Error while getting/creating Family with surname '{surname}': {str(e)}")
            return f"Error while getting/creating Family: {str(e)}"
        ...
        if head_data:
            try:
                ...
                logger.error(f"Error while processing family head data: {str(e)}")
                return f"Error while processing family head data: {str(e)}"
        else:
            logger.warning("No family head data provided!")
            return "No family head data provided!"

        # Process members list data
        ...
        if members_list:
            ...
            logger.warning("No members data provided!")
            return "No members data provided!"
...
def memberdetail(md,msg,h):
     try:
        ...
        if step==-1:
            ...
            if msg=="R" or msg=="r":
                if md==all_data["head of family"]:
                    ...
                    md['step']=-1
                    reply = f"Going back!\nEnter the relation of the {h} with the Head of the family"
            ...
            if msg=="R" or msg=="r":
                ...
                reply=f"You entered Permanent address: {msg}\nEnter Landline number of the {h}, if not enter null.\n\nor\n\n(Enter 'R' to Re-enter the previous input)"
                md['step']=11
            ...
            if msg=="R" or msg=="r":
                ...
                if msg.lower() != 'null' and not msg.isdigit():
                    reply=f"You entered the landline number {msg}. Please enter the correct number or enter 'Null'."
                    logging.warning(f"Invalid landline number entered: {msg}. Length is {len(msg)}. {reply}")
                else:
                    md['landline_no']=msg
        ...
        # Log the reply message to be sent to the user
            ...
            logger.error(f"An error occurred in step {step} for {h}: {str(e)}")
    ...
    if request.method == 'POST':
        ...
        if step == 0:
            ...
            try:
                ...
                logger.error(f"Error in step 1 processing: {e}")
            ...
            try:
                ...
                logger.error(f"Error in step 2 processing: {e}")
                reply = "An error occurred. Please try again."
            ...
            try:
                ...
                logger.error(f"Error in step 3 processing: {e}")
                reply = "An error occurred. Please try again."
            ...
            try:
                ...
                logger.error(f"Error in step 4 processing: {e}")
                reply = "An error occurred. Please try again."
             ...
             try:
                ...
                logger.error(f"Error in step 5 processing: {e}")
                reply = "An error occurred. Please try again."
